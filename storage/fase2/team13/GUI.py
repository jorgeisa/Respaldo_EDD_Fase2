...
def ventana_db(ventana):
    ...
    j = checkMode('json')
    # GRAPH DATABASES
    # path = graphStructure(j, 'avl', 'database', None, None)
    path = graphStructure(j, 'json', 'table', 'db68', None)
    path2 = graphStructure(j, 'json', 'tuple', 'db68', 'Table1_DB68')
